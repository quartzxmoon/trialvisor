...
type Trial={id:string;provider:string;plan:string;price:number;currency:string;trialEnd:string;safeDeadline:string;plannedExecution:string;providerTrialEndDate?:string;hasExplicitTime?:boolean;state:string;tier:string;support?:'GUIDED'|'NOT_SUPPORTED';confidence:number;confidenceBand?:'HIGH'|'MEDIUM'|'LOW';evidence?:string;nextAction?:string;authorizationAt?:string;providerActionAt?:string;cancellationUrl?:string;sourceRef?:{provider:'google'|'microsoft';messageId:string;threadId:string;receivedAt?:string};verificationRef?:{provider:'google';messageId:string;threadId:string;receivedAt?:string};activity?:CustomerActivity[]};
